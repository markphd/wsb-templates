...
{ index: 5,
  ...
  name: 'Bakery',
  categories: [ 'food_and_hospitality' ] },
{ index: 6,
...
{ index: 13,
  ...
  name: 'Vogue',
  categories: [ 'business_and_services', 'online_store', 'premium' ] },
{ index: 14,
...
{ index: 18,
  ...
  name: 'Book Club',
  categories: [ 'family_and_recreation', 'events' ] },
{ index: 19,
...
{ index: 33,
  ...
  name: 'Coach',
  categories: [ 'business_and_services', 'portfolios', 'premium' ] },
{ index: 34,
  id: '1AFA77CC-A0C5-4543-93D4-72EE8CC8C4F7',
  pageId: '3D50B879-D6BA-4E9C-8AD1-D1BE07EB8BDC',
  name: 'Model Building',
  categories: [ 'family_and_recreation', 'music' ] },
{ index: 35,
...
{ index: 38,
  ...
  name: 'Young Chefs',
  categories: [ 'food_and_hospitality', 'events' ] },
{ index: 39,
...
{ index: 41,
  ...
  name: 'Topiary',
  categories: [ 'family_and_recreation' ] },
{ index: 42,
...
{ index: 60,
  ...
  name: 'Upsurge',
  categories: [ 'business_and_services', 'family_and_recreation', 'premium' ] },
{ index: 61,
...
{ index: 66,
  ...
  name: 'Mart',
  categories: [ 'food_and_hospitality', 'online_store' ] },
{ index: 67,
...
{ index: 73,
  ...
  name: 'Coffee Time',
  categories: [ 'food_and_hospitality', 'online_store', 'premium' ] },
{ index: 74,
...
{ index: 109,
  ...
  name: 'Boundless Art',
  categories: [ 'portfolios', 'music', 'online_store' ] },
{ index: 110,
...
{ index: 124,
  ...
  name: 'The Villa',
  categories: [ 'business_and_services', 'food_and_hospitality', 'premium' ] },
{ index: 125,
...
class App extends Component {
  componentWillMount() {
    ...
    db.find({"pages.id": { $in: this.state.publishedTemplates } }, (err, templates) => this.setState( (state) => state = {templates} ))
  }
  ...
  findTemplateOrder() {
    ...
    this.state.templates.filter( item => {
      ...
      for(const value of templatePages){
        if (this.state.publishedTemplates.indexOf(value.id) >= 0) {
          templateOrder.push({index: this.state.publishedTemplates.indexOf(value.id), id: item.id, pageId: value.id, name: item.name, categories: item.categories})
        } else {
        console.log(this.state.publishedTemplates.indexOf(value.id), value.id, item.name, item.categories)
        }
  ...
  onPreviewTemplate(template) {
    ...
    this.setState( (state) => state.currentTemplate = template.target.attributes['data-template'])
  }
        ...
        <div className="TemplateContainer">
          <ul className="TemplateList">
            {templateOrder.map( item => {
              return <Fade><li className="TemplateListItem"><Fade><p>{item.name}</p></Fade><img onClick={this.onPreviewTemplate} src={`img/${item.pageId}.png`} data-template={`${item.pageId}`}/></li></Fade>
            })}
          </ul>
